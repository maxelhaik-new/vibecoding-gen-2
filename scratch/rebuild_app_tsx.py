...
if target_states in code:
    ...
    print("Applied state declarations replacement successfully.")
else:
...
if target_func in code:
    ...
    print("Applied handleSendChatMessage insertion successfully.")
else:
    print("ERROR: Target function anchor not found!")
...
if target_layout in code:
    ...
    print("Applied main layout and activity bar successfully.")
else:
    print("ERROR: Target layout structure not found!")
...
if target_main in code:
    ...
    print("Applied central workspace wrapper successfully.")
else:
    print("ERROR: Target central workspace main tag not found!")
...
if start_idx != -1 and end_idx != -1:
    ...
    print("Applied right sidebar, footer and mobile nav replacement successfully using indices.")
else:
    print("ERROR: Could not locate right sidebar indices!")
