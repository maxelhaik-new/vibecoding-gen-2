...
with open('/Users/maximeelhaik/Documents/VIBE CODING GENERATION/glossaire_formation_vibe_coding.md', 'r', encoding='utf-8') as f:
    lines = f.readlines()
...
for line in table_lines[2:]: # skip header and separator
    ...
    if len(parts) >= 5:
        ...
        # Clean word_raw markdown formatting like **word**
...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Disposer les pages cote a cote a l'ecran */
    .pages-wrapper {
      display: flex;
      flex-direction: row;
      gap: 2rem;
    ...
    /* Page A4 physique sans bordure */
    .a4-page {
      width: 210mm;
      height: 297mm;
      background: var(--color-bg-white);
      border: none; /* Pas de bordure pour les pages */
    ...
    /* Carte terme brutaliste avec bordures subtiles gris clair */
    .term-item {
      background: var(--color-bg-white);
      border: 1px solid var(--color-border-subtle); /* Bordure subtile gris clair */
    ...
    /* Badge type : TOUS en Jaune sur Noir */
    .type-tag {
      background: #18093B;
      color: #FFFF77;
      font-weight: 800;
...
<body>
  ...
  <div class="screen-actions">
    <span>📄 Glossaire Complet — 57 termes (12 pages A4 disposes cote a cote)</span>
...
output_path = '/Users/maximeelhaik/Documents/VIBE CODING GENERATION/glossaire_cheatsheet_complet.html'
with open(output_path, 'w', encoding='utf-8') as f:
    f.write(html_content)

print(f"Glossaire HTML complet écrit dans {output_path}")
