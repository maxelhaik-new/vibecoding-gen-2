...
COLOR_MAP = {
    "theorique": {"name": "Gris clair", "hex": "#E2E4E9"},
    "logiciel": {"name": "Violet", "hex": "#C4B5FD"},
    "hybride": {"name": "Rose", "hex": "#FFB5E8"},
    "cas_pratique": {"name": "Bleu clair", "hex": "#A0D2FF"}
}
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Cadrer son projet certifiant & Définir le produit"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        ...
                        "Titre 1": "Exigences certification", "Texte 1": "Voyons les règles des épreuves et les critères d'évaluation de la certification.",
                        "Titre 2": "Dossier de cadrage", "Texte 2": "Zoom sur la formalisation du besoin et du parcours utilisateur.",
                        "Titre 3": "Règles contextuelles", "Texte 3": "Découvrons comment paramétrer les consignes de l'agent dans AGENTS.md."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre étapes clés pour démarrer son projet sur des bases solides.",
                        "Titre 1": "Comprendre la certification", "Texte 1": "Analyser la grille d'évaluation et les deux épreuves du diplôme.", "Picto 1": "mdi:clipboard-check-outline",
                        "Titre 2": "Choisir l'application", "Texte 2": "Sélectionner un projet métier pertinent et adapté au Vibe Coding.", "Picto 2": "mdi:lightbulb-on-outline",
                        "Titre 3": "Rédiger le cadrage", "Texte 3": "Compléter le dossier de cadrage avec objectifs et périmètre.", "Picto 3": "mdi:file-document-edit-outline",
                        "Titre 4": "Définir AGENTS.md", "Texte 4": "Fixer les règles contextuelles et techniques pour l'agent IA.", "Picto 4": "mdi:cog-box"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Générer l'Interface Utilisateur (Front-end & UX)"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Design system", "Texte 1": "Voyons comment prompter la structure visuelle et la charte graphique.",
                        "Titre 2": "Composants métier", "Texte 2": "Zoom sur la création des formulaires, cartes et tableaux de données.",
                        "Titre 3": "Dynamisme Front-end", "Texte 3": "Découvrons comment rendre l'interface interactive avant le branchement backend."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre priorités pour réussir l'expérience utilisateur de son projet fil rouge.",
                        "Titre 1": "Définir la charte", "Texte 1": "Établir les couleurs, la typographie et les composants de base.", "Picto 1": "mdi:palette-swatch-outline",
                        "Titre 2": "Construire les écrans", "Texte 2": "Générer les vues métier principales du parcours utilisateur.", "Picto 2": "mdi:view-dashboard-variant-outline",
                        "Titre 3": "Corriger le style", "Texte 3": "Ajuster l'ergonomie visuelle et affiner les détails UI avec l'agent.", "Picto 3": "mdi:auto-fix",
                        "Titre 4": "Simuler les états", "Texte 4": "Gérer les modales, le chargement et la réactivité de l'écran.", "Picto 4": "mdi:lightning-bolt-outline"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Connecter la base de données Cloud (Supabase BaaS)"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Rôle du Back-end", "Texte 1": "Voyons pourquoi le navigateur seul ne permet pas de conserver les données.",
                        "Titre 2": "Projet Supabase", "Texte 2": "Zoom sur la création de la base cloud et la configuration des clés.",
                        "Titre 3": "Modélisation SQL", "Texte 3": "Découvrons comment générer la structure des tables avec l'agent IA."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre piliers pour rendre son application capable de stocker ses informations.",
                        "Titre 1": "Comprendre le BaaS", "Texte 1": "Saisir les avantages d'un Backend-as-a-Service pour aller vite.", "Picto 1": "mdi:cloud-outline",
                        "Titre 2": "Configurer Supabase", "Texte 2": "Créer l'instance cloud et récupérer l'URL ainsi que la clé anon.", "Picto 2": "mdi:database-cog-outline",
                        "Titre 3": "Créer les tables SQL", "Texte 3": "Générer et exécuter le schéma SQL du projet fil rouge.", "Picto 3": "mdi:table-furniture",
                        "Titre 4": "Lier les formulaires", "Texte 4": "Connecter les actions de l'écran à la base de données.", "Picto 4": "mdi:swap-horizontal"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Authentification & Espace Membre Privé"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Identité & Session", "Texte 1": "Voyons comment les jetons de connexion protègent l'accès aux données.",
                        "Titre 2": "Pages de connexion", "Texte 2": "Zoom sur l'intégration du formulaire d'inscription et d'authentification.",
                        "Titre 3": "Routes privées", "Texte 3": "Découvrons comment restreindre les vues réservées aux membres connectés."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre exigences pour gérer l'accès et la confidentialité des utilisateurs.",
                        "Titre 1": "Gérer les sessions", "Texte 1": "Comprendre le mécanisme de jetons JWT et la persistance de connexion.", "Picto 1": "mdi:key-wireless",
                        "Titre 2": "Intégrer Auth", "Texte 2": "Connecter Supabase Auth à la page de connexion de l'application.", "Picto 2": "mdi:account-lock-outline",
                        "Titre 3": "Protéger le Dashboard", "Texte 3": "Bloquer l'accès aux pages sensibles pour les visiteurs anonymes.", "Picto 3": "mdi:shield-lock-outline",
                        "Titre 4": "Associer auth.uid()", "Texte 4": "Rattacher chaque donnée créée à l'identifiant de son propriétaire.", "Picto 4": "mdi:account-arrow-right-outline"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Sécuriser les données par la faille (RLS)"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Démontrer la faille", "Texte 1": "Voyons la vulnérabilité majeure qui permet d'usurper les données d'autrui.",
                        "Titre 2": "Règles SQL RLS", "Texte 2": "Zoom sur la création des politiques de sécurité Row Level Security.",
                        "Titre 3": "Audit & Validation", "Texte 3": "Découvrons comment vérifier l'étanchéité absolue de l'application."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre étapes indispensables pour valider le critère éliminatoire CE5.3.5.",
                        "Titre 1": "Repérer la vulnérabilité", "Texte 1": "Constater qu'un utilisateur peut lire les données d'un autre sans RLS.", "Picto 1": "mdi:bug-outline",
                        "Titre 2": "Activer le RLS", "Texte 2": "Activer Row Level Security sur l'ensemble des tables de la base.", "Picto 2": "mdi:shield-bug-outline",
                        "Titre 3": "Rédiger les politiques", "Texte 3": "Générer les règles SQL limitant l'accès aux seules lignes de auth.uid().", "Picto 3": "mdi:code-json",
                        "Titre 4": "Auditer l'étanchéité", "Texte 4": "Tester dans le navigateur que chaque compte est totalement isolé.", "Picto 4": "mdi:check-decagram-outline"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Connecter le monde extérieur (API & Secrets)"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Concepts d'API REST", "Texte 1": "Voyons comment fonctionnent les requêtes HTTP et les échanges de données JSON.",
                        "Titre 2": "Fichier .env.local", "Texte 2": "Zoom sur l'isolation des clés API et le masquage des secrets.",
                        "Titre 3": "Branchement externe", "Texte 3": "Découvrons comment connecter un service tiers (Stripe, Resend, API métier)."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre compétences pour enrichir son produit fil rouge avec des services externes.",
                        "Titre 1": "Comprendre les API", "Texte 1": "Saisir le rôle des endpoints HTTP pour communiquer avec l'extérieur.", "Picto 1": "mdi:api",
                        "Titre 2": "Masquer les secrets", "Texte 2": "Isoler les clés d'accès dans le fichier d'environnement local.", "Picto 2": "mdi:incognito",
                        "Titre 3": "Interroger l'API", "Texte 3": "Rédiger les requêtes de données via l'agent IA de manière sécurisée.", "Picto 3": "mdi:arrow-decision-auto-outline",
                        "Titre 4": "Valider les flux", "Texte 4": "Vérifier que les données transmises restent étanches et sans fuite.", "Picto 4": "mdi:swap-horizontal-bold"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
        ...
        "lessons": [
            {
                ...
                "type": "theorique",
                "slides": [
                    {"template": "VIBECODING - COVER", "content": {"Titre": "Les objectifs du chapitre : Déploiement en production & Réussir son projet certifiant"}},
                    {"template": "VIBECODING - INTRO", "content": {
                        "Titre": "De quoi parlons-nous ?",
                        ...
                        "Titre 1": "Production Vercel", "Texte 1": "Voyons comment mettre l'application en ligne sur une URL HTTPS publique.",
                        "Titre 2": "Documentation GitHub", "Texte 2": "Zoom sur la publication d'un dépôt propre et la rédaction d'un README complet.",
                        "Titre 3": "Dossier & Épreuves", "Texte 3": "Découvrons comment enregistrer la démonstration vidéo et préparer le QCM."
                    }},
                    {"template": "VIBECODING - 4 BLOCS", "content": {
                        "Titre": "Les objectifs du chapitre",
                        "Intro": "Quatre étapes finales pour soumettre son dossier et décrocher la certification.",
                        "Titre 1": "Déployer sur Vercel", "Texte 1": "Mettre en ligne le projet avec variables d'environnement de production.", "Picto 1": "mdi:rocket-launch-outline",
                        "Titre 2": "Publier sur GitHub", "Texte 2": "Versionner le code et rédiger la documentation technique dans le README.", "Picto 2": "mdi:github",
                        "Titre 3": "Tourner la vidéo", "Texte 3": "Enregistrer la démonstration produit expliquant le fonctionnement réel.", "Picto 3": "mdi:video-wireless-outline",
                        "Titre 4": "Préparer le QCM", "Texte 4": "Réviser les notions théoriques pour valider la seconde épreuve du diplôme.", "Picto 4": "mdi:school-outline"
                    }},
                    {"template": "VIBECODING - FIN", "content": {
                        "Titre": "En résumé",
...
# Build both flat lessons array and grouped chapters structure
flat_lessons = []
grouped_chapters = []
...
for ch in chapters:
    ...
    for idx, les in enumerate(ch["lessons"]):
        ...
        les_obj = {
            ...
            "newRow": (idx == 0), # Indique un retour à la ligne pour le premier élément du chapitre
            "slides": les["slides"]
        }
...
full_export = {
    ...
    "moduleSlug": "module-5",
    "colorLegend": {
        "theorique": {"label": "Leçon Théorique", "color": "Gris clair", "hex": "#E2E4E9"},
        "logiciel": {"label": "Logiciel", "color": "Violet", "hex": "#C4B5FD"},
        "hybride": {"label": "Hybride", "color": "Rose", "hex": "#FFB5E8"},
        "cas_pratique": {"label": "Cas Pratique", "color": "Bleu clair", "hex": "#A0D2FF"}
    },
    "layoutRule": "Chaque chapitre commence sur une nouvelle ligne (newRow: true). Aucun chevauchement.",
    "chapters": grouped_chapters,
    "lessons": flat_lessons
}

target_path = "/Users/maximeelhaik/Documents/VIBE CODING GENERATION/FINAL_MODULE5_FIGMA.json"
with open(target_path, "w", encoding="utf-8") as f:
    json.dump(full_export, f, indent=2, ensure_ascii=False)

print(f"✅ FINAL_MODULE5_FIGMA.json généré avec succès dans {target_path}")
