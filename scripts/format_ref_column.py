...
# Standardize lesson reference format for "Non défini (Cité)" terms
# Must strictly match the format "CODE — TITRE COMPLET DE LA LEÇON" used for defined terms
...
clean_terms = [
    ...
    },
    {
        ...
        "ref": "M2C5L3 — Bannir les clés API et secrets de ses prompts"
    },
    {
        "mot": "AGENTS.md",
        "statut": "Défini",
    ...
    },
    {
        ...
        "ref": "M1C4L5 — Mettre en place une routine de veille efficace"
    },
    {
        "mot": "Back-end",
        "statut": "Défini",
    ...
    },
    {
        ...
        "ref": "M1C1L4 — Découvrir l'écosystème Git et GitHub"
    },
    {
    ...
    },
    {
        ...
        "ref": "M1C3L5 — Comprendre le réseau et les requêtes web"
    },
    {
    ...
    },
    {
        ...
        "ref": "M1C4L6 — Comprendre et utiliser le terminal"
    },
    {
        "mot": "Logs d'erreur",
        "statut": "Défini",
    ...
    },
    {
        ...
        "ref": "M1C4L3 — L'injection de contexte et la documentation"
    },
    {
        "mot": "React",
        "statut": "Défini",
    ...
    },
    {
        ...
        "ref": "M4C5L2 — Refactoriser son code avec l'agent"
    },
    {
...
sorted_terms = sorted(clean_terms, key=lambda x: x["mot"].lstrip(".").lower())
...
print(f"✅ Format de référence de leçon harmonisé avec succès dans {target_path} ({len(sorted_terms)} termes).")
