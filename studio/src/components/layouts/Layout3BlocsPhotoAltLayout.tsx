...
export const Layout3BlocsPhotoAltLayout: React.FC<LayoutProps> = ({ content, onChange, rules }) => {
  return (
...
export default Layout3BlocsPhotoAltLayout;