...
export default async function handler(req, res) {
  ...
  const systemInstruction = `Tu es l'assistant Vibe Slicer Online. Tu aides l'utilisateur à créer, structurer, découper et rédiger des leçons de cours avec des slides JSON. Sois concis, précis et utile.${lessonContext}`;
